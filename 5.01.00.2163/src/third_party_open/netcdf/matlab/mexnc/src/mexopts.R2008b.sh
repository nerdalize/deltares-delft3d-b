...
###     and "--disable-shared --enable-netcdf-4 --with-hdf5=/home/johne/local/nc4"
#          HDF5="/local/nc4-static"
#          NETCDF="/local/nc4-static"
#          CFLAGS="$CFLAGS -g -I${NETCDF}/include  "
#          CLIBS="-L${NETCDF}/lib -lnetcdf -L${HDF5}/lib -lhdf5_hl -lhdf5 -lz $CLIBS "
#
### MACI
...
### MACI
### opendap libraries installed via fink
#          NETCDF="/sw"
#          CFLAGS="$CFLAGS -g -I${NETCDF}/include/libdap  -I${NETCDF}/include/libnc-dap"
#          CLIBS="-L${NETCDF}/lib -lnc-dap -ldapclient -ldap $CLIBS"
### MACI
### opendap libraries manually installed
          NETCDF="/opt/opendap-static"
          CFLAGS="$CFLAGS -g -I${NETCDF}/include/libdap  -I${NETCDF}/include/libnc-dap"
          CLIBS="-L${NETCDF}/lib -lnc-dap -ldapclient -ldap -L/sw/lib -lcurl -lxml2 -lz -liconv -lm -lpthread $CLIBS"
#           FC="$FC"
#           FFLAGS="$FFLAGS"
